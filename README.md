...
| **Level 28 to 29** | Inspecting Git commit history (`git log`) and checking out historical commits (`git switch --detach` / `git checkout`) to recover sensitive data removed in later revisions       | [View Notes](https://github.com/rs-dot369/linux-vault/blob/main/overthewire-bandit/Level28-29.md) |
| **Level 29 to 30** | Inspecting hidden and remote branches (`git branch -r`, `.git/packed-refs`) to locate passwords stored in non-default development branches or hidden commits                      | [View Notes](https://github.com/rs-dot369/linux-vault/blob/main/overthewire-bandit/Level29-30.md) |

...
| :----------------- | :---------------------------------------------------------------------------- | :-------------------------- |
| **Level 0**        | Introduction to wargames, bandit, login using (`ssh`)                         | [View Notes](Level0.md)     |
| **Level 0 to 1**   | Introduction to file searching (`find`) and exploring local directories       | [View Notes](Level0-1.md)   |
| **Level 20 to 21** | Working with network sockets, netcat (`nc`), and local port communication     | [View Notes](Level20-21.md) |
| **Level 21 to 22** | Inspecting cron jobs (`/etc/cron.d/`) and automated system scripts            | [View Notes](Level21-22.md) |
| **Level 22 to 23** | Analyzing script logic, variables (`whoami`), and hashed filenames (`md5sum`) | [View Notes](Level22-23.md) |
